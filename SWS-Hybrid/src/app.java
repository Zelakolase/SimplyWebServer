...
public class app {
	...
	public static void main(String[] args) throws IOException {
		/*
		 * Form of input : 45;44;115 }-> byte decimals by semicolon delimiter
		 */
		...
		// Output formation. 45;44;115,HTTP/1.1 200 OK,html/text }-> response in decimal
		// by semicolon delimiter, HTTP code, MIME type
		// Output is the request itself
		String stdout = Arrays.toString(request.getBytes()).replaceAll("\\[", "").replaceAll("\\]", "")
				.replaceAll(",\\s+", ";") + ",HTTP/1.1 200 OK,text/html";
